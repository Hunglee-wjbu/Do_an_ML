...
from root.pages.Util import CombinedAttributesAdder
...
housing = pd.read_csv('.\\root\\pages\\CaliHousing\\housing.csv')
...
class PredictCaliHouse(HydraHeadApp):
    def run(self):
        ...
        if(select == "Linear Regression"):
            model = joblib.load('.\\root\\pages\\CaliHousing\\lin_reg.pkl')
        elif(select == "Random Forest Regression"):
            model = joblib.load('.\\root\\pages\\CaliHousing\\forest_reg.pkl')
        elif(select == "Random Forest Regression Grid Search CV"):
            model = joblib.load('.\\root\\pages\\CaliHousing\\forest_reg_grid_search.pkl')
        elif(select == "Random Forest Regression Random Search CV"):
            model = joblib.load('.\\root\\pages\\CaliHousing\\forest_reg_random_search.pkl')
